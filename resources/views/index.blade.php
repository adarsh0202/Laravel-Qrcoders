...
<head>
    ...
    <meta name="author" content="Adarsh Kotian">
    <!-- Font -->
                    ...
                    <nav class="navbar navbar-dark navbar-expand-lg">
                        ...
                        <div class="collapse navbar-collapse" id="navbar">
                            <ul class="navbar-nav ml-auto">
                                ...
                                <li class="nav-item"><a href="#" onclick="window.location='{{ url("home") }}'" class="btn btn-outline-light my-3 my-sm-0 ml-lg-3">LOGIN HERE</a></li>
                            </ul>
                        </div>
                    </nav>
                </div>
