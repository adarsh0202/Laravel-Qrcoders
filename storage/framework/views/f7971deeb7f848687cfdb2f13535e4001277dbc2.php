...
<html lang="en">
<head>
    <title>QRCoders WebApp | Student Attendance</title>
    <!-- Meta tags -->
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <meta name="description" content="QRCoders - Mobile WebApp which uses QR Codes for Student Attendance System">
    <meta name="keywords" content="HTML5, qr, student, webapp, bootstrap, mobile, app, landing, ios, android, responsive">
    <meta name="author" content="Sumer Patel">
    <!-- Font -->
...
<body data-spy="scroll" data-target="#navbar" data-offset="30">
                    ...
                    <nav class="navbar navbar-dark navbar-expand-lg">
                        ...
                        <div class="collapse navbar-collapse" id="navbar">
                            <ul class="navbar-nav ml-auto">
                                ...
                                <li class="nav-item"><a href="#" onclick="window.location='<?php echo e(url("home")); ?>'" class="btn btn-outline-light my-3 my-sm-0 ml-lg-3">LOGIN HERE</a></li>
                            </ul>
                        </div>
                    </nav>
                </div>
    ...
    <header class="bg-gradient" id="home">
        <div class="container mt-5">
            <h1>QRCoders WebApp</h1>
            <p class="tagline">The one and only solution needed for any kind of Student Attendance System. Check our website to learn more about the various features and how it will help to solve your problems! </p>
        </div>
                        ...
                        <div class="card-body">
                            <div class="media">
                                ...
                                <div class="media-body">
                                    ...
                                    <p class="card-text">QRCoders is very handy and simple. It is made with Students and Teachers need for easy interface </p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="media">
                                ...
                                <div class="media-body">
                                    ...
                                    <p class="card-text">QRCoders uses Laravel security which helps to prevent vulnerabilities such as XSS, SQL Injection, etc </p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 offset-lg-6">
                    ...
                    <h2>Discover our WebApp</h2>
                    <p class="mb-4">Learn about QRCoders in a more detailed manner by experiencing our WebApp and going through the various features we provide. </p>
                    <a href="#feature" class="btn btn-primary">Read more</a>
                </div>
            </div>
            <div class="perspective-phone">
                <img src="images/perspective.png" alt="phone" class="img-fluid">
            </div>
        </div>
    </div>
    <!-- // end .section -->
            ...
            <div class="row">
                ...
                <div class="col-md-6 d-flex align-items-center">
                    <div>
                        ...
                        <h2>Launch our WebApp</h2>
                        <p class="mb-4">Users can experience our WebApp on various platforms as it provides cross platform simplicity on iOS, Android, Windows, etc. </p>
                    ...
                    <ul class="list-unstyled ui-steps">
                        <li class="media">
                            ...
                            <div class="media-body">
                                ...
                                <p>Register yourself on QRCoders by providing 'Name' & 'UID' to respective college department </p>
                            </div>
                        </li>
                        <li class="media my-4">
                            <div class="circle-icon mr-4">2</div>
                            <div class="media-body">
                                <h5>No Proxy, Be Happy</h5>
                                <p>QR codes allow Teachers to keep a proper track of attendance for students who are attending lectures </p>
                            </div>
                        </li>
                        <li class="media">
                            <div class="circle-icon mr-4">3</div>
                            <div class="media-body">
                                <h5>Enjoy your College life</h5>
                                <p>No need to worry about attendance anymore, Everything will be handled by our QRCoders System </p>
                            </div>
                        </li>
                    </ul>
                </div>
        ...
        <div class="container">
            ...
            <div class="testimonials owl-carousel">
                <div class="testimonials-single">
                    ...
                    <h5 class="mt-4 mb-2">Dr. Rajesh Bansode </h5>
                    <p class="text-primary">Head of Department-(I.T.) <br> Thakur College of Engineering and Technology </p>
                </div>
                <div class="testimonials-single">
                    <img src="images/client.png" alt="client" class="client-img">
                    <blockquote class="blockquote">Uniquely streamline highly efficient scenarios and 24/7 initiatives. Conveniently embrace multifunctional ideas through proactive customer service. Distinctively conceptualize 2.0 intellectual capital via user-centric partnerships.</blockquote>
                    <h5 class="mt-4 mb-2">Mr. Sandip Bankar </h5>
                    <p class="text-primary">Assistant Professor-(I.T.) <br> Thakur College of Engineering and Technology </p>
                </div>
                <div class="testimonials-single">
                    <img src="images/client.png" alt="client" class="client-img">
                    <blockquote class="blockquote">Uniquely streamline highly efficient scenarios and 24/7 initiatives. Conveniently embrace multifunctional ideas through proactive customer service. Distinctively conceptualize 2.0 intellectual capital via user-centric partnerships.</blockquote>
                    <h5 class="mt-4 mb-2">Mrs. Shruti Mathur </h5>
                    <p class="text-primary">Assistant Professor(I.T.) <br> Thakur College of Engineering and Technology </p>
                </div>
                <div class="testimonials-single">
                    <img src="images/client.png" alt="client" class="client-img">
                    <blockquote class="blockquote">Uniquely streamline highly efficient scenarios and 24/7 initiatives. Conveniently embrace multifunctional ideas through proactive customer service. Distinctively conceptualize 2.0 intellectual capital via user-centric partnerships.</blockquote>
                    <h5 class="mt-4 mb-2">Mr. Shridhar Kamble </h5>
                    <p class="text-primary">Assistant Professor-(I.T.) <br> Thakur College of Engineering and Technology </p>
                </div>
                <div class="testimonials-single">
                    <img src="images/client.png" alt="client" class="client-img">
                    <blockquote class="blockquote">Uniquely streamline highly efficient scenarios and 24/7 initiatives. Conveniently embrace multifunctional ideas through proactive customer service. Distinctively conceptualize 2.0 intellectual capital via user-centric partnerships.</blockquote>
                    <h5 class="mt-4 mb-2">Mrs. Neha Kapadia</h5>
                    <p class="text-primary">Assistant Professor-(I.T.) <br> Thakur College of Engineering and Technology </p>
                </div>
            </div>
        </div>
...
// end .section -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 text-center text-lg-left">
                    <p class="mb-2"> <span class="ti-location-pin mr-2"></span>  Thakur College of Engineering and Technology, Mumbai</p>
                    <div class=" d-block d-sm-inline-block">
                        <p class="mb-2">
                            <span class="ti-email mr-2"></span> <a class="mr-4" href="mailto:support@qrcoders.com">support@qrcoders.com</a>
                        </p>
                    </div>
                    <div class="d-block d-sm-inline-block">
                        <p class="mb-0">
                            <span class="ti-headphone-alt mr-2"></span> <a href="tel:09912345678">099-1234-5678</a>
                        </p>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="social-icons">
                        <a href="https://github.com/" title="Github!"><span class="ti-github"></span></a>
                        <a href="https://www.facebook.com/" title="Facebook!"><span class="ti-facebook"></span></a>
                        <a href="https://www.instagram.com/" title="Instagram"><span class="ti-instagram"></span></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <footer class="my-5 text-center">
        ...
        <p class="mb-2"><small>COPYRIGHT © 2019. ALL RIGHTS RESERVED. DESIGNED WITH ❤ BY <a href="index.html">QRCoders</a></small></p>
